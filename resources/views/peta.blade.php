...
<html>
	...
	<body style="background-image: url('img/color.png');">
		...
		<script>
			...
			{"loc":[-2.977251, 104.774985], "title":"Palembang"},
			{"loc":[-0.031174, 110.120284], "title":"Tayan"},
			{"loc":[-6.918780, 107.622558], "title":"Bandung"},
			{"loc":[-3.318354, 114.595370], "title":"Banjarmasin"},
			{"loc":[-6.170694, 106.644504], "title":"Tangerang"},
			{"loc":[-0.875055, 131.256841], "title":"Sorong"},
			{"loc":[-0.862307, 134.066888], "title":"Manokwari"},
			{"loc":[-2.216282, 113.915494], "title":"Palngkaraya"},
			{"loc":[-10.177651, 123.607680], "title":"Kupang"},
	];
			...
			////////////populate map with markers from sample datall
			for(i in data) {
